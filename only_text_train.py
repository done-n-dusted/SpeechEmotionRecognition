...
txt_grand = '../../mitacs/MELD_text_aug/'
...
name = 'text_' + txt_noise + '_training'

train_csv = wrapper(txt_grand, 'train', noise)
test_csv = wrapper(txt_grand, 'test', noise)
dev_csv = wrapper(txt_grand, 'dev', noise)
...
for n in noise2:
    for noise_type in noise_types:
        n1 = noise_type + n
        print('\n', n1, '\n')
        dset_csv = wrapper(txt_grand, 'train', n1)
...
dump(scaler, open('../models/text_scaler.pkl', 'wb'))
...
model.save('../models/text_model.h5', include_optimizer = False)